...
(defn collection
  [name]
  (str "com.etzhayyim.shinka." name))

(def cell-specs {
  :get {:legacy-cell "com-etzhayyim-apps-shinka-coverage-get"
     :phase :event
  ...
  :domain-knowledge {:legacy-cell "domain-knowledge"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :self-evolution {:legacy-cell "self-evolution"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "self-evolution")]
     :required-gates common-gates
     :trigger "manifest cell self-evolution"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :propagationevent {:legacy-cell "com-etzhayyim-apps-shinka-propagationEvent"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "propagationevent")]
     :required-gates common-gates
     :trigger "manifest cell propagationevent"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :propagationjob {:legacy-cell "com-etzhayyim-apps-shinka-propagationJob"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "propagationjob")]
     :required-gates common-gates
     :trigger "manifest cell propagationjob"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
