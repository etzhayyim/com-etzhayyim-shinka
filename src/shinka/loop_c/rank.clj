...
(def docs-dir (io/file here ".." ".." ".." "docs" "loop_c"))
...
(let [scored (->> (:candidates G)
  ...
  (spit (io/file data-dir "scorecard.edn") (with-out-str (clojure.pprint/pprint out)))
  ...
  (let [md (StringBuilder.)]
    ...
    (spit (io/file docs-dir "scorecard.md") (str md)))
